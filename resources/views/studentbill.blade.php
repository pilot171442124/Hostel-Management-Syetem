                    ...
                    <div class="col-lg-4">
                        <div class="ibox">
                            <div class="ibox-content bg-info ">
                                ...
                                <a href="{{ url('currentmonthbill') }}"><i class="fa fa-arrow-right"></i> Current Month Bill</a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox">
                            <div class="ibox-content bg-success">
                                ...
                                <a href="{{ url('paidbill') }}" style="color:white"> <i class="fa fa-arrow-right"></i> Paid Bill</a>
 ...
 <div class="col-lg-4">
                        <div class="ibox">
                            <div class="ibox-content bg-warning">
                                ...
                                <a href="{{ url('unpaidbill') }}"> <i class="fa fa-arrow-right"></i> Unpaid Bill</a>
...
$( ".StudentPayment-menu" ).addClass( "active" );
		...
		$( ".bkashpayment-menu" ).addClass( "active" );
